...
parser.add_argument("--test_set_size", default=1000, type=int, help="How many samples from test set to take, 0 means all")
...
parser.add_argument("--generation_method", default="fewshot", type=str, help="whole, lines, fewshot")
...
if args.from_dict == True:
    input_sections = HT_loader(args.dataset_path, language="en", without_repetition=True, shuffle=True)
