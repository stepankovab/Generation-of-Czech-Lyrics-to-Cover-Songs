...
python $DATADIR/train_model.py --model 'OSCAR_GPT2' --model_path $DATADIR/trained_models --generation_method 'whole' --dataset_path $DATADIR --dataset_type 13  >> $DATADIR/Out_file_OSCAR_GPT2_whole_13.out
clean_scratch