...
python $DATADIR/train_model.py --model 'OSCAR_GPT2' --model_path $DATADIR/trained_models --generation_method 'lines' --dataset_path $DATADIR --dataset_type 6  >> $DATADIR/Out_file_OSCAR_GPT2_lines_6.out
clean_scratch