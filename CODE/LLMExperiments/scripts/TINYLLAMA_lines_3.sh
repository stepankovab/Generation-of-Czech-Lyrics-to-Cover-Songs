...
python $DATADIR/train_model.py --model 'TINYLLAMA' --model_path $DATADIR/trained_models --generation_method 'lines' --dataset_path $DATADIR --dataset_type 3  >> $DATADIR/Out_file_TINYLLAMA_lines_3.out
clean_scratch