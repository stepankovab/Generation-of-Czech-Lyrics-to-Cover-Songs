...
python $DATADIR/train_model.py --model 'TINYLLAMA' --model_path $DATADIR/trained_models --generation_method 'whole' --dataset_path $DATADIR --dataset_type 1  >> $DATADIR/Out_file_TINYLLAMA_whole_1.out
clean_scratch