...
python $DATADIR/train_model.py --model 'VUT_TINYLLAMA' --model_path $DATADIR/trained_models --generation_method 'lines' --dataset_path $DATADIR --dataset_type 9  >> $DATADIR/Out_file_VUT_TINYLLAMA_lines_9.out
clean_scratch