...
python $DATADIR/train_model.py --model 'TINYLLAMA' --model_path $DATADIR/trained_models --generation_method 'whole' --dataset_path $DATADIR --dataset_type 12  >> $DATADIR/Out_file_TINYLLAMA_whole_12.out
clean_scratch