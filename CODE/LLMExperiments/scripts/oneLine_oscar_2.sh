...
python $DATADIR/train_one_line.py --model "GPT2_oscar" --dataset_path $DATADIR --dataset_type 2 >> $DATADIR/Out_file_oscar_2.out || { echo >&2 "Calculation ended up erroneously (with a code $?) !!"; exit 3; }
