...
python $DATADIR/train_model.py --model 'VUT_GPT2' --model_path $DATADIR/trained_models --generation_method 'whole' --dataset_path $DATADIR --dataset_type 11  >> $DATADIR/Out_file_VUT_GPT2_whole_11.out
clean_scratch