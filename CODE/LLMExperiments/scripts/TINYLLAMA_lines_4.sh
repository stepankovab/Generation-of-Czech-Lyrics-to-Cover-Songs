...
python $DATADIR/train_model.py --model 'TINYLLAMA' --model_path $DATADIR/trained_models --generation_method 'lines' --dataset_path $DATADIR --dataset_type 4  >> $DATADIR/Out_file_TINYLLAMA_lines_4.out
clean_scratch