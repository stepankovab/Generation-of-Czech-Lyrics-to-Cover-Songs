...
python $DATADIR/train_one_line.py --model "GPT2_oscar" --dataset_path $DATADIR --dataset_type 6 >> $DATADIR/Out_file_oscar_6.out || { echo >&2 "Calculation ended up erroneously (with a code $?) !!"; exit 3; }
