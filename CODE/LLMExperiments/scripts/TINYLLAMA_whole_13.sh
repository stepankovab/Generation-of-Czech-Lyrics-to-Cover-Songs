...
python $DATADIR/train_model.py --model 'TINYLLAMA' --model_path $DATADIR/trained_models --generation_method 'whole' --dataset_path $DATADIR --dataset_type 13  >> $DATADIR/Out_file_TINYLLAMA_whole_13.out
clean_scratch