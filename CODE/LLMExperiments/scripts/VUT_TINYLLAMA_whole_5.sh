...
python $DATADIR/train_model.py --model 'VUT_TINYLLAMA' --model_path $DATADIR/trained_models --generation_method 'whole' --dataset_path $DATADIR --dataset_type 5  >> $DATADIR/Out_file_VUT_TINYLLAMA_whole_5.out
clean_scratch