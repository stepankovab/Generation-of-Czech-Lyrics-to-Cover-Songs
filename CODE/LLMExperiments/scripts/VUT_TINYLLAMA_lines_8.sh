...
python $DATADIR/train_model.py --model 'VUT_TINYLLAMA' --model_path $DATADIR/trained_models --generation_method 'lines' --dataset_path $DATADIR --dataset_type 8  >> $DATADIR/Out_file_VUT_TINYLLAMA_lines_8.out
clean_scratch