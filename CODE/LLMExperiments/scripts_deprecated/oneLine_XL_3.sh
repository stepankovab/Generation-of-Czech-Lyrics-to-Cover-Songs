...
python $DATADIR/train_one_line.py --model "GPT2_czech_XL" --dataset_path $DATADIR --dataset_type 3 >> $DATADIR/Out_file_XL_3.out || { echo >&2 "Calculation ended up erroneously (with a code $?) !!"; exit 3; }
