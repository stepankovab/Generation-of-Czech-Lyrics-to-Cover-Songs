...
python $DATADIR/train_one_line.py --model "tinyLlama" --dataset_path $DATADIR --dataset_type 6 >> $DATADIR/Out_file_ll_6.out || { echo >&2 "Calculation ended up erroneously (with a code $?) !!"; exit 3; }
