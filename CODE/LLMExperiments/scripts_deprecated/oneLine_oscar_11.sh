...
python $DATADIR/train_one_line.py --model "GPT2_oscar" --dataset_path $DATADIR --dataset_type 11 >> $DATADIR/Out_file_oscar_11.out || { echo >&2 "Calculation ended up erroneously (with a code $?) !!"; exit 3; }
