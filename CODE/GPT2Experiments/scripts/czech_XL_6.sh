...
python $DATADIR/GPT2_baseline_infer.py --model "GPT2_czech_XL" --dataset_path $DATADIR --dataset_type 6 >> $DATADIR/Out_file_czXL6i.out || { echo >&2 "Calculation ended up erroneously (with a code $?) !!"; exit 3; }
